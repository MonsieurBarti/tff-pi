...
export function requestReview(
	...
	return new Promise((resolve) => {
		...
		const unsubscribe = pi.events.on(REVIEW_RESULT_CHANNEL, (data: unknown) => {
			...
			// Only match after plannotator has given us its own reviewId.
			// If it hasn't yet, any event on this channel is from some other
			// concurrent request and must be ignored.
			if (!plannotatorReviewId || event.reviewId !== plannotatorReviewId) return;
